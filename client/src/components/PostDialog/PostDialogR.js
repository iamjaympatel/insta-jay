...
import CommentR from '../Comment/CommentR';
...
function PostDialogR  ({
 ...
 const history = useHistory();
  //const state =useSelector((state)=>state.postdialog)
...
PostDialogR.whyDidYouRender = true;

export default connect(mapStateToProps, mapDispatchToProps)(PostDialogR);
